    ...
    return(
        <div className="bg-[#022B69] md:flex sm:grid justify-between pl-[60px] pt-[100px] pb-[20px] w-full">
            <div className="pt-[80px]">
                <h1 className="text-[#fff] font-medium text-3xl pb-[30px] w-[372px]">Save Invest & Earn Anywhere !</h1>
                <p className="text-[#fff] text-base w-[327px] pb-[30px]">Ipsum massa at cursus lacus erat lacus magna volutpat habitasse. Eu mauris et .</p>
